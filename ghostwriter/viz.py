...
def roc(results, path):
    fig, ax = plt.subplots(figsize=(6.2, 5)); _ax(ax)
...
def feature_importance(names, importances, path):
    ...
    fig, ax = plt.subplots(figsize=(7, 5)); _ax(ax)
...
def calibration(y, proba, path):
    ...
    fig, ax = plt.subplots(figsize=(6, 5)); _ax(ax)
...
def adversarial(before, after, path):
    fig, ax = plt.subplots(figsize=(5.5, 4.2)); _ax(ax)
